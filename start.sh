...
echo -e "${BOLD}${MAGENTA}╠══════════════════════════════════════════════════════════════╣${NC}"
echo -e "${MAGENTA}║  ${YELLOW}系统管理员${MAGENTA}   admin         admin123     韩雨(管理员)       ║${NC}"
echo -e "${MAGENTA}║  ${YELLOW}管理员二${MAGENTA}     admin2        admin123     后台运营           ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}李明${MAGENTA}         liming        123456       普通家长(爸爸)     ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}张薇${MAGENTA}         zhangwei      123456       普通家长(妈妈)     ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}王芳${MAGENTA}         wangfang      123456       普通家长(妈妈)     ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}刘洋${MAGENTA}         liuyang       123456       普通家长(爸爸)     ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}陈洁${MAGENTA}         chenjie       123456       普通家长(妈妈)     ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}赵云${MAGENTA}         zhaoyun       123456       普通家长(爸爸)     ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}孙丽${MAGENTA}         sunli         123456       普通家长(妈妈)     ║${NC}"
echo -e "${MAGENTA}║  ${CYAN}周斌${MAGENTA}         zhoubin       123456       已禁用             ║${NC}"
echo -e "${BOLD}${MAGENTA}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
